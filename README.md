...
## Step 1: Compiling custom kernel
...
<details>
  <summary>Compiling the 6.6.x kernel: Step-by-step guide</summary>
  Instructions for building an x86_64 WSL2 6.6.x kernel with an Ubuntu distribution using bash are as follows:
...
* Download de kernel (always in a /home/user/ directory)<br>
...
* Copy de generated kernel and modules to the desired folder<br>
...
## Setup
> Recommended to install Waydroid in a brand new Ubuntu install.
